...
class AccountTest(unittest.TestCase):
    ...
    def test_set_leverage(self):
        print(self.AccountAPI.set_leverage(lever="5", mgnMode="isolated", instId="BTC-USDT"))

    def test_get_max_order_size(self):
        print(self.AccountAPI.get_max_order_size(instId="BTC-USDT", tdMode="cash"))
    ...
    def test_set_isolated_mode(self):
        print(self.AccountAPI.set_isolated_mode(isoMode="automatic", type="MARGIN"))
    ...
    def test_position_builder(self):
        ...
        print(self.AccountAPI.position_builder(inclRealPosAndEq=False, simPos=sim_pos, simAsset=sim_asset, greeksType='CASH'))
    ...
    def test_borrow_repay(self):
        print(self.AccountAPI.borrow_repay(ccy="BTC", side="borrow", amt="1.0"))
