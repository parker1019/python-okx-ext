...
QUICK_BORROW_REPAY_HISTORY = '/api/v5/account/quick-margin-borrow-repay-history' # Need to add
...
PRESET_ACCOUNT_LEVEL_SWITCH = '/api/v5/account/account-level-switch-preset' # Need to add
PRECHECK_ACCOUNT_LEVEL_SWITCH = '/api/v5/account/set-account-switch-precheck' # Need to add
